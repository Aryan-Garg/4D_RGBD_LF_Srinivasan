...
#parameters
# -------------------------------------------------------------------
lfsize = [352, 528, 7, 7] # dimensions of Lytro light fields
...
train_path = '/data/prasan/datasets/LF_datasets/Kalantari/train' # path to training examples
test_path = '/data/prasan/datasets/LF_datasets/Kalantari/test/'
